...
public class Database {
	...
	private final ConcurrentHashMap<MenuItem, BigDecimal> pricesAudit = new ConcurrentHashMap<>();
	...
	public List<MenuItem> menuItemsList() {
		List<MenuItem> list = new ArrayList<>(items.values());
		list.sort(Comparator.comparing(MenuItem::id, Comparator.nullsLast(Long::compareTo)));
		return list;
	}
